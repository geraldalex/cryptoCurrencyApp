...
import {
    ...
    TouchableOpacity,
    SafeAreaView, 
    Image, ScrollView, Animated, Platform,
} from 'react-native';
...
<View style={{marginRight:SIZES.base}}>
    ...
    <Text style={{...FONTS.body4, textAlign:'right', color:COLORS.gray}}>{selectedCurrency?.wallet.crypto}
...
<View style={{marginTop: Platform.OS === 'android' ? Constants.statusBarHeight + 5 : 0}}>
